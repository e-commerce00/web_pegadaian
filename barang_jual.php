...
<head>
    ...
    <title>Barang Jual - Jaya Group</title>
    <!-- Boostrap 5 -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">Barang Siap Jual</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <a class="btn btn-warning" href="tambah_barang_jual.php" role="button">Tambah Barang Jual</a>
                                <a class="btn btn-info" href="print/print_barang_jual.php" role="button">Cetak</a>
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align: center;">
                                    <thead> 
                                        ...
                                        $data = mysqli_query($koneksi, "SELECT * FROM baran_jual ORDER BY tanggal_masuk DESC");
                                        //$data = mysqli_query($koneksi, "SELECT * FROM barang_gadai ORDER BY tanggal_tempo ASC");
                                        $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $d['minus'] ?></td>
                                            <td><a href="jual_barang.php?id_jual=<?php echo $d['id_jual'] ?>" class="btn btn-success btn-circle"><i class="fas fa-money-bill"></i></a></td>
                                            <td><a href="detail_barang_jual.php?id_jual=<?php echo $d['id_jual'];?>" class="btn btn-info btn-circle"> <i class="fas fa-info-circle"></i></a></td>
                                        </tr>
                                        <?php
                                        }
                                        ?>
